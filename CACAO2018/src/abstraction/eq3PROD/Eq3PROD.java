...
//			}
			...
			this.getJournal().ajouter("Stock moyenne qualité : "+ longToString((long) getStockQMoy().getValeur())+" tonnes");
			this.getJournal().ajouter("Stock haute qualité : "+ longToString((long) getStockQHaut().getValeur())+" tonnes");
