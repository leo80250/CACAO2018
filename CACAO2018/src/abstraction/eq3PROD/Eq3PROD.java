...
//			}
			...
			this.getJournal().ajouter("Stock moyenne qualité : "+ longToString((long) getStockQMoy().getValeur()));
			this.getJournal().ajouter("Stock haute qualité : "+ longToString((long) getStockQHaut().getValeur()));
